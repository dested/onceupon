...
- Audio sent to a paid transcriber is metered; the spend chip shows an estimated ears cost at the resolved vendor's per-minute rate (OpenAI live $0.017, Deepgram $0.0077), which the user can override in Settings.
